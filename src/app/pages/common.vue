<template>
    <div>
        <NavMenu></NavMenu>
        <Row>
            <Col span="2" offset="1"><PasswordArea :password="password100" desc="常用密码100"></PasswordArea></Col>
            <Col span="2" offset="1"><PasswordArea :password="password1700" desc="常用密码1700"></PasswordArea></Col>
        </Row>
